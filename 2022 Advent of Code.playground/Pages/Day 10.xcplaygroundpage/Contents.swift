...
addx -5
"""
let testInput2 = try readResourceFile("test-input2.txt")

let test1 = HandheldDevice(code: testInput1)
let test2 = HandheldDevice(code: testInput2)
let device = HandheldDevice(code: try readResourceFile("input.txt"))

verify([
    (test1, -1 * (20 + 60 + 100 + 140 + 180 + 220)),
    (test2, 13140),
    (device, 13820)
]) { device in
    device.part1()
...
/**
 ...
 So, by [carefully timing](https://www.youtube.com/watch?v=sJFnWZH5FXc) the CPU instructions and the CRT drawing operations, you should be able to determine whether the sprite is visible the instant each pixel is drawn. If the sprite is positioned such that one of its three pixels is the pixel currently being drawn, the screen produces a **lit** pixel (`#`); otherwise, the screen leaves the pixel **dark** (`.`).
