...
let exampleAnswerPart1 = solvePartOne(exampleInput, start: 3231929, length: 1, end: 3231930)
assert(exampleAnswerPart1 == "1")

let exampleAnswerPart2 = solvePartOne(exampleInput, start: 5017308, length: 2, end: 5278569)
assert(exampleAnswerPart2 == "8f")
