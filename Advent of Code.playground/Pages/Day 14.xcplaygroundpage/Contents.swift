...
let exampleCandidates = CandidateKeys(dataStream: "abc".randomDataStream())
let exampleKeys = Array(exampleCandidates.keyStream.prefix(64))
assert(exampleKeys[63] == 22728)

let input = "ngcjuoqr"
let candidates = CandidateKeys(dataStream: input.randomDataStream())
let keys = Array(candidates.keyStream.prefix(64))
let part1Answer = keys[63]
