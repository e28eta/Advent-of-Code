...
let part1 = Building([Floor(chips: [.strontium, .plutonium], generators: [.strontium, .plutonium]),
                      Floor(chips: [.ruthenium, .curium], generators: [.thulium, .ruthenium, .curium]),
                      Floor(chips: [.thulium]),
                      Floor()])

guard let part1Answer = part1.shortestPath() else {
    fatalError("Could not solve Part 1")
}

assert(part1Answer.cost == 37)
